...
class GetInputs:
    ...
    def __init__(self, sch='ES'):
        """
        Constructor
        :param sch: School level- ES (Elementary School), MS (Middle School), HS (High School)
        :return: None
        """
        self.sch = sch
        self.read_path = '../data/'
    ...
    def get_adj_list(self, spas_nbrlist):
        """
        Determines the adjacency matrix of the SPAs as a data frame
        :param spas_nbrlist: Adjacency relationship as a dictionary
    ...
    def remove_links(self, spas_nbrlist, sch_spas_nbrlist):
        """
        Remove links between SPAs that contain school inside them.
        :param spas_nbrlist: Adjacency relationship of SPAs
        :param sch_spas_nbrlist: Adjacency relationship of school-containing SPAs
        :return: None
        """
    ...
    def read_json_file(file_loc):
        ...
        :param file_loc: String containing the location of a file
        :return: json file
        """
    ...
    def get_sch_spas(self, schools, spas_nbrlist):
        ...
        :param schools: Geospatial files of the schools
        :param spas_nbrlist: Adjacency relationship of school-containing SPAs
        :return: json file
        """
    ...
    def get_pop_cap(self, spas, schools):
        ...
        :param spas: Geospatial data of the spatial units
        :param schools: Geospatial data of the school locations
        :return: Dictionary containing the student population and school capacity of the spatial units
        """
